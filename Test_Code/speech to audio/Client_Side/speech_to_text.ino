...
const int SAMPLE_DURATION = 6;                        // duration of fixed sampling (seconds)
...
//        char buff[]="sad happy hot dog";
      ...
      //      char subtrans2[]="hot";
        ...
        char body[100]="user=A&message=";
        strcat(body,subtrans);
        int body_len=strlen(body);
        sprintf(request_buffer,"POST http://608dev.net/sandbox/sc/linx3/words.py HTTP/1.1\r\n");
        ...
        //CHANGE WHERE THIS IS TARGETED! IT SHOULD TARGET YOUR SERVER SCRIPT
        //CHANGE WHERE THIS IS TARGETED! IT SHOULD TARGET YOUR SERVER SCRIPT
      //  sprintf(request_buffer, "GET /sandbox/sc/yuyu/wiki_getter.py?topic=%s HTTP/1.1\r\n", query);
      //  strcat(request_buffer, "Host: 608dev.net\r\n");
      //  strcat(request_buffer, "\r\n"); //new line from header to body
      
        do_http_request("608dev.net", request_buffer, response, 200, RESPONSE_TIMEOUT, true);
...
void speaking(){
  ...
  sprintf(requesting,"GET http://608dev.net/sandbox/sc/linx3/words.py?user=B");
//  strcat(requesting,sentence);
  strcat(requesting," HTTP/1.1\r\n");
  strcat(requesting,"Host: 608dev.net\r\n");
  strcat(requesting,"\r\n"); //add blank line!
  do_http_request("608dev.net", requesting, result, 1000,RESPONSE_TIMEOUT, true);
